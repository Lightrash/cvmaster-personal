    ...
    <div className="min-h-screen bg-[#f3f3f4] dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 transition-colors duration-300">
      ...
      <main className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 sm:p-8">
        <section className="w-full max-w-[560px] rounded-[34px] border border-neutral-300 dark:border-neutral-700 bg-[#f5f5f6] dark:bg-neutral-900 px-8 py-9 sm:px-12 sm:py-11 shadow-[0_2px_10px_rgba(0,0,0,0.03)] transition-colors duration-300">
          <div className="mb-7">
            <h1 className="text-[40px] leading-none font-semibold">Login to your account</h1>
            <p className="mt-3 text-[20px] leading-7 text-neutral-500 dark:text-neutral-400">Enter your email below to sign in</p>
          </div>
